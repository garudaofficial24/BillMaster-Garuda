...
const CreateLetter = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${API}/letters`, submitData);
  ...
  return (
    <div data-testid="create-letter-page">
      <div className="mb-6">
        <Button
          variant="ghost"
        ...
        <h1 className="text-3xl font-bold text-slate-800 mb-2">Buat Surat Baru</h1>
        <p className="text-slate-600">Isi formulir untuk membuat surat resmi</p>
      </div>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    placeholder="Contoh: Bapak/Ibu Direktur Utama"
                    required
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    placeholder="Contoh: Direktur Utama PT XYZ"
                  />
                </div>
                <div>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={handleInputChange}
                    rows={10}
                    placeholder="Tulis isi surat di sini. Gunakan enter untuk paragraf baru."
                    required
                  />
                ...
                {signatories.map((signatory, index) => (
                  <div key={index} className="border rounded-lg p-4 space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        Upload gambar tanda tangan (max 2MB)
                      </p>
                    </div>
                  </div>
                ))}
